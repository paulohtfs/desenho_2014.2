...
<html>
	...
	<body>
		<a href="#list-commentary" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="commentaryDescription" title="${message(code: 'commentary.commentaryDescription.label', default: 'Commentary Description')}" />
					
						<g:sortableColumn property="commentaryDate" title="${message(code: 'commentary.commentaryDate.label', default: 'Commentary Date')}" />
