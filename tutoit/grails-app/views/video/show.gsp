	...
	<body>
		...
		<div id="show-video" class="content scaffold-show" role="main">
			...
			<ol class="property-list video">
				...
				<li class="fieldcontain">
					<span id="videoName-label" class="property-label"><g:message code="video.videoName.label" default="Nome do video" /></span>
				...
				<li class="fieldcontain">
					<span id="videoLink-label" class="property-label"><g:message code="video.videoLink.label" default="Link: " /></span>
				...
				<li class="fieldcontain">
					<span id="publishDate-label" class="property-label"><g:message code="video.publishDate.label" default="Data de publicação: " /></span>
				...
				<li class="fieldcontain">
					<span id="commentaries-label" class="property-label"><g:message code="video.commentaries.label" default="Comentários: " /></span>
				...
				<li class="fieldcontain">
					<span id="category-label" class="property-label"><g:message code="video.category.label" default="Categoria: " /></span>
				...
				<li class="fieldcontain">
					<span id="user-label" class="property-label"><g:message code="video.user.label" default="Usuário" /></span>
